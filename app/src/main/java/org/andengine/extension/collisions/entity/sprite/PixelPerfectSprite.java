package org.andengine.extension.collisions.entity.sprite;
...
import org.andengine.extension.collisions.bindings.ShapeAdapter;
import org.andengine.extension.collisions.entity.shape.IPixelPerfectShape;
import org.andengine.extension.collisions.opengl.texture.region.PixelPerfectTextureRegion;
	...
	public boolean collidesWith(final IShape pOtherShape) {
		if(super.collidesWith(pOtherShape))
		{
			...
			else
			{
				...
				reusableRectangularPixelPerfectMask.setTo((int) ((Rectangle) pOtherShape).getWidth(), (int) ((Rectangle) pOtherShape).getHeight());
